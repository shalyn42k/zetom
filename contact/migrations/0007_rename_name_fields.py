# === FILE SUMMARY ===
# Purpose: Migrate name fields by adding full_name/company_name and updating references.
# Responsible for: Adding new fields, migrating existing name data, and dropping obsolete fields.
# Connected to: ContactMessage model schema evolution.
# Important classes/functions: combine_names(), noop_reverse(), Migration
# Notes: Includes generated timestamp from Django migrations.
# =====================================
