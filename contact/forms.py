...
class EmailForm(forms.Form):
    ...
    main_message = forms.CharField(
        initial=(
            "Dzień dobry.\n\n"
            "W załączniku umieściłem ofertę cenową na wykonanie wzorcowania "
            "przyrządu pomiarowego wyszczególnionego w zapytaniu ofertowym."
        ),
    ...
    quote_body = forms.CharField(
        ...
        initial=(
            ...
            "1. Usługa wzorcowania maszyny wytrzymałościowej na rozciąganie: "
            "wytwórca DSI, NIEMCY TYP HOZ 4000/250\n\n"
            "Z poważaniem,\n\n"
            "Jarosław Ługowyj\n"
